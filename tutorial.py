...
if __name__ == "__main__":
    speak("I'm awake")
    print(commands)
    print("Ask me nicely to use the following commands: 'Wikipedia' followed by your search query to get me to search Wikipedia | 'Go to' followed by a website name to open the website | 'Tell me a joke' to get me to tell you funny joke | 'Play' followed by a song to get my to play it")
    speak("Ask me nicely to use the following commands: Wikipedia followed by your search query to get me to search Wikipedia. Go to followed by a website name to open the website. Tell me a joke to get me to tell you a funny joke. 'Play' followed by a song to get my to play it")
